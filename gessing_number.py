# in this game you have to guess a secret number
# conditions
# if the digit in the secret wnumber but it is not on currect position so it will print pico
# and if the digit is currect on currect position it will print fermi 
# and the digit not in the secret number so it will pring begls
